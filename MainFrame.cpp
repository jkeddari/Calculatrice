...
/***********    L I G N E    4   ******************/
	...
	btnPG = new wxButton(this, ID_BTN_PG, _T("(")); // Création du bouton (
	...
	btnFact->SetBackgroundColour(wxColour(255,255,0,100));
	...
	gridButton->Add(btnPD,0,wxEXPAND);
	gridButton->Add(btnFact,0,wxEXPAND);
...
void MainFrame::OnButton_FACT_Clicked(wxCommandEvent &event){
	*txtCalcInput << "fact(";
	calcul+="fact(";
}
...
BEGIN_EVENT_TABLE(MainFrame,wxFrame)
	...
	EVT_BUTTON(ID_BTN_FACT, MainFrame::OnButton_FACT_Clicked)
	...
	EVT_BUTTON(ID_BTN_PD, MainFrame::OnButton_PD_Clicked)
