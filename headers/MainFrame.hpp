...
enum{
	...
	ID_BTN_LN, ID_BTN_EXP, ID_BTN_LOG, ID_BTN_PUISS, ID_BTN_FACT, ID_BTN_RACINE,
...
/************* B U T T O N S ******************************************************************************/
		...
		wxButton *btnLn,*btnExp,*btnLog,*btnPuiss,*btnFact,*btnRacine; //Fonction basique
		...
		wxStaticText *btnVide; //Bouttons vide
/**********************************************************************************************************/
		...
		void OnButton_FACT_Clicked(wxCommandEvent &event);
